...
from models.user import User                  # <-- Added this
...
def send_money(user_id, beneficiary_id, amount, description):
    ...
    # Simulate recipient receiving money if they’re a registered user
    recipient_user = None
    ...
    if recipient_user:
        ...
        if recipient_wallet:
            recipient_wallet.balance += amount  # Recipient gets full amount; sender covers fee
